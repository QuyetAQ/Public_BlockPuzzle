...
function drawLogo(_xx, _yy, _scale) {
    ...
    ctx.textAlign = "center";
    ctx.save()
    ctx.fillText("BLOCK", titlePos.x, titlePos.y);
    ctx.restore()
    ctx.save()
    ctx.font = "bold 118px Tahoma";
    ctx.fillText("PUZZLE", titlePos.x + 5, titlePos.y + 120);
    ctx.restore()
...
function story22() {
    setStoryMessage(["More precisely 13.312", "but that isn't a problem", "for the Block Puzzle!", " ",
...
function story32() {
    setStoryMessage(["Oh, the dev left a note, too:", " ", "Did you really finish", "Block Puzzle?", " ",
...
function story13() {
    setStoryMessage(["OKAY, let's roll up", "our sleeves and get", "those Blockychums back!", " ", "Remember:", "any game mode is fine,", "as long as you feel comfortable.", " ", "Block Puzzle!"])
...
function sendRandomMessage() {
    ...
    var randomMessages = ["Put them into the ship!", "Drag and drop them in!", "Double click to rotate!", "This is a fun one!", "Block Puzzle!",
            ...
            setTimeout(function () {
                ...
                if (polyLeft > 0) {
                    ...
                    if (storyState == 1) {
                        ...
                        canSkip = true
                        animateMouth = true
                        setStoryMessage(["Block Puzzle!!!", "We did it, Spacey!!!", " ", "WE ACTUALLY RESCUED ALL", "the 13.312 Blockychums!", " ",
